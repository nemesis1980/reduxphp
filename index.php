...
<title>Chuck Norris Facts</title> <link rel="stylesheet" type="text/css" href="css/styles.css">
</head>
<body>
 <header>
 ...
 <?php 
		 ...
		 ###############################################################################################
			...
			<div class="joke">
					<img src="' . $joke['img'] . '" class="norris_pic" alt="Chuck Norris caricature"/> <h2>' . $joke['joke'] .  '</h2>	       
           </div>';
